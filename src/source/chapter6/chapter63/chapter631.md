Кількість вироблених комплектів виробів та розподіл виробничої програми між підприємствами при зміні кількості виробів 1-го типу у комплекті наведено у таблиці 6.17. Відповідні графіки наведено на рисунку 6.9.

#### Таблиця 6.17. Значення розв'язку задачі в залежності від кількості виробів 1-го типу у комплекті
...
#### Рисунок 6.9. Графік змін розв'язку задачі в залежності від кількості виробів 1-го типу у комплекті.

![image6-9](../../image/image6-9.png)

Як можна побачити з отриманих даних зміна кількості виробів 1-го типу у комплекті значною мірою впливає на кількість вироблених комплектів виробів, а також і на розподіл виробничої програми між підприємствами. 

При збільшенні кількості виробів 1-го типу з 1 до 10 кількість вироблених комплектів знижується приблизно на 50%. Щодо розподілу виробничої програми, зростає кількість підприємств третього типу, які орієнтовані на виготовлення виробу другого типу, та відповідно знижується кількість підприємств третього типу, орієнтованих на виготовлення виробів першого типу. Кількість підприємств третього типу, які орієнтовані на виготовлення виробу третього типу знижується до нуля. Розподіл підприємств першого, другого та четвертого типів не змінюється. Розподіл підприємств п'ятого типу змінюється незначною мірою.

Нижче у таблицях та графіках представлені зміни кількості вироблених комплектів виробів та розподілу виробничої програми між підприємствами при зміні кількості виробів другого та третього типів у комплекті.