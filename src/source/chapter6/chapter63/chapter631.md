...
#### Таблиця 6.17. Значення розв'язку задачі в залежності від від кількості виробів 1-го типу у комплекті
