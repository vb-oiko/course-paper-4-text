Кількість вироблених комплектів виробів та розподіл виробничої програми між підприємствами при зміні кількості підприємств 2-го типу наведено у таблиці 6.21. Відповідні графіки наведено на рисунку 6.13.

#### Таблиця 6.21. Значення розв'язку задачі в залежності від кількості підприємств 2-го типу

<table>
    <thead>
        <tr>
            <th>Кількість підприємств 2-го типу </th>
            <th>5</th>
            <th>10</th>
            <th>15</th>
            <th>20</th>
...
#### Рисунок 6.13. Графік змін розв'язку задачі в залежності від кількості підприємств 2-го типу.

![image6-13](../../image/image6-13.png)

Як можна побачити з отриманих даних зміна кількості підприємств 2-го типу впливає на кількість вироблених комплектів підприємств, а також і на розподіл виробничої програми між підприємствами. 

При збільшенні кількості підприємств 2-го типу з 5 до 50 кількість вироблених комплектів збільшується приблизно на 37%. Щодо розподілу виробничої програми, зростає кількість підприємств третього типу, які орієнтовані на виготовлення виробу другого типу та підприємств другого типу, які орієнтовані на випуск виробів третього типу. Розподіл підприємств першого, четвертого та п'ятого типів не змінюється.