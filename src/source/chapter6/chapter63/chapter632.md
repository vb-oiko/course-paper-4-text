Кількість вироблених комплектів виробів та розподіл виробничої програми між підприємствами при зміні кількості виробів 2-го типу у комплекті наведено у таблиці 6.18. Відповідні графіки наведено на рисунку 6.10.

#### Таблиця 6.18. Значення розв'язку задачі в залежності від кількості виробів 2-го типу у комплекті

<table>
    <thead>
        <tr>
            <th>Кількість виробів 2-го типу у комплекті</th>
            <th>1</th>
            <th>2</th>
            <th>3</th>
            <th>4</th>
...
#### Рисунок 6.10. Графік змін розв'язку задачі в залежності від кількості виробів 2-го типу у комплекті.

![image6-10](../../image/image6-10.png)

Як можна побачити з отриманих даних зміна кількості виробів 2-го типу у комплекті значною мірою впливає на кількість вироблених комплектів виробів, а також і на розподіл виробничої програми між підприємствами. 

При збільшенні кількості виробів 2-го типу з 4 до 10 кількість вироблених комплектів знижується приблизно на 40%. Щодо розподілу виробничої програми, зростає кількість підприємств третього типу, які орієнтовані на виготовлення виробу другого типу, та відповідно знижується кількість підприємств третього типу, орієнтованих на виготовлення виробів третього типу. 

При зменшенні кількості виробів 2-го типу з 4 до 1 кількість вироблених комплектів збільшується приблизно на 37%. Щодо розподілу виробничої програми, зростає кількість підприємств третього типу, які орієнтовані на виготовлення виробу третього типу, та відповідно знижується кількість підприємств третього типу, орієнтованих на виготовлення виробів другого типу. 

Кількість підприємств першого, другого та четвертого типів не змінюється. Кількість підприємств п'ятого типу змінюється незначною мірою.
